...
<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatablePrice"></div>
        </div>
...
<script>
     var KTDatatableJsonRemoteDemo = function(data) {
                ...
                var datatable = $('#kt_datatable').KTDatatable({
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            return `\
                            <button type="button" class="btn btn-primary" onclick="modal(${row.id})">\
                                Prices\
                            </button>\ 
        ...
        var KTDatatablePriceJson = function(data) {
            // Private functions
            ...
            var demo = function(data) {
                // console.log(JSON.parse(data));
                var datatable = $('#kt_datatablePrice').KTDatatable({
                    // datasource definition
                    data: {
                        type: 'local',
                        source: data,
    ...
    jQuery(document).ready(function() {
        KTDatatableJsonRemoteDemo.init(<?php echo($products) ?>);
    });
    function modal(id){
            $.ajax({
                        url: window.location.origin + `/prices/${id}`,
                        method: "GET",
                    })
                        .done(function (data) {
                            $('#Modal').modal('show')
